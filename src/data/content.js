...
export const SONGS = [
  ...
  },
  {
    ...
    videoUrl: "/assets/videos/Loomy Healthy Drinks Song.mp4",
  ...
  },
  {
    ...
    lyrics: [
      ...
      "Stretch your little arms up high!",
      "Rub your sleepy eyes so slow,",
      "Time to wake and start the glow",
      "Wash wash little hands so clean",
      "Bubbles bubbly in between!",
      "Splash splash water on your face,",
      "Ready for a happy day",
      "Good morning smiles — yay yay yay!",
      "Happy healthy start today!",
      "Wash and stretch and dance around,",
      "Morning giggles all around",
      "Healthy breakfast yummy yum",
      "Milk and fruit inside my tum!",
      "Water sip and big hooray,",
      "Strong smiles growing every day",
      "Brush brush little teeth today",
      "Chase the sleepy bugs away!",
      "Top and bottom, front and back,",
      "Healthy smiles are on the track",
      "Good morning smiles — yay yay yay!",
      "Happy healthy start today!",
      "Brush and stretch and dance around,",
      "Morning giggles all around",
      "Good morning sunshine bright",
      "Healthy smiles shining light!",
      "Wave hello and start the day,",
      "DentBloom smiles all the way",
    ],
    movementGuide: [
